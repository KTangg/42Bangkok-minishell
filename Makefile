...
#    Updated: 2022/04/09 06:57:26 by tratanat         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ms_main.c ms_main_input.c ms_main_line.c\
		...
		ms_parse_vars_utils.c ms_vars_cleanup.c ms_parse_file.c ms_wildcards.c \
		ms_built_cmd.c ms_built_err.c ms_built_utils.c ms_built_unset.c \
